...
/** @brief Installs the format info getter function for the Publisher
	...
	Example Refer to the Format Register Test example project of the API Development Kit.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPublisherFormatInfoGetter (const char* mimeType, InfoGetterProc* infoGetterProc);
...
/** @brief Change extrusion material of beam segment.
	@ingroup Element
	@since Archicad 27.2
	@param api_beamSegment [in] The segment object to change the extrusion material.
	@param extrusionMaterial [in] The new material.
	@param setToOverride [in] The override status of the new extrusion material.
	@param withdel [in] Delete the original instance of the element, or keep it and create a new one.
	@return
		- NoError - The function has been completed with success.
		- APIERR_BADPARS - The passed api_beamSegment is nullptr or extrusionMaterial has not value.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_ChangeBeamSegment_ExtrusionMaterial (API_BeamSegmentType*		api_beamSegment,
