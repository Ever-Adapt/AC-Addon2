...
public:
	...
	static void PseudonymGSIDInfo (IGDLRequests* req, Int32 nrvals, Int32* retValue, GDLRequestResult& values);
};

typedef void PseudonymGSIDInfoFuncType (IGDLRequests* req, Int32 nrvals, Int32* retValue, GDLRequestResult& values);

extern GDL_DLL_EXPORT PseudonymGSIDInfoFuncType* PseudonymGSIDInfoCallback;
